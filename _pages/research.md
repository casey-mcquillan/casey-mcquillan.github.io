...
[ [Abstract](#){: onclick="event.preventDefault(); toggleAbstract('abstract_FMZZ')" .paper-link} | [Published Version](https://www.brookings.edu/wp-content/uploads/2024/01/16653-BPEA-SP23_WEB_Finkelstein-et-al_session_print.pdf){: target="\_blank" .paper-link} | [NBER Working Paper](https://www.nber.org/papers/w31091){: target="\_blank" .paper-link} | [Code](https://github.com/casey-mcquillan/fmzz){: target="\_blank" .paper-link} |
