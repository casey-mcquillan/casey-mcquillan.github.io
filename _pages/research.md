...
[ [Abstract](#){: onclick="event.preventDefault(); toggleAbstract('abstract_JMP')" .paper-link} | [Draft](https://esd.wa.gov/media/pdf/4240/endogenoustake-upuibenefts-working-paper-oct2025pdf/download?inline){: target="_blank"  rel="noopener noreferrer" .paper-link} | [SSRN Version](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5692222){: target="_blank"  rel="noopener noreferrer" .paper-link} ]
<div id="abstract_JMP">
