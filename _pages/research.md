...
[[Abstract](#){: onclick="toggleAbstract('abstract1')" .paper-link} · [Draft](https://arxiv.org/pdf/2301.00001.pdf){: target="_blank" .paper-link}]
...
### **Incomplete and Endogenous Take-Up of Unemployment Insurance Benefits** (with Brendan Moore)  
[[Abstract](#){: onclick="toggleAbstract('abstract3')" .paper-link} · [Draft](https://arxiv.org/pdf/2301.00001.pdf){: target="_blank" .paper-link}] 
